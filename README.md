...
# ThryEditor support:
UTS2-AC has custom GUI support with Thry Editor. Install and update from their 3rd party package from:
https://github.com/Thryrallo/ThryEditor
Create a holding folder paste the Editor\ folder inside your project. My shader properties will then change when its installed. Watch if you have already installed Thry before from another source. 
